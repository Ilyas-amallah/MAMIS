    ...
    <div id="productCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="images/olive.png" class="d-block w-100" alt="Oil 1">
        </div>
        <div class="carousel-item">
          <img src="images/olive.png" class="d-block w-100" alt="Oil 2">
        </div>
        <div class="carousel-item">
          <img src="images/olive.png" class="d-block w-100" alt="Oil 3">
        </div>
      </div>
